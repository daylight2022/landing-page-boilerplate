...
export const FEATURES_EN = [
	...
	},
	{
		...
		content: 'Templates meticulously designed to ensure optimal display on any device.',
		icon: FaMobileScreenButton,
	},
	{
		title: 'Easy Customization',
		content: 'Effortlessly change colors, fonts, and layouts without any coding knowledge.',
		icon: FaToolbox,
	},
	{
		title: 'SEO Optimized',
		content: "Templates built with search engine optimization in mind to enhance your website's discoverability.",
		icon: MagnetIcon,
	},
	{
		title: 'One-Click Deployment',
		content: 'Tightly integrated with leading web hosting services for instant website publishing.',
		icon: MdCloudUpload,
	},
	{
		title: 'Globalization Support',
		content: 'Supports multiple languages, making your website attractive to a global audience.',
		icon: FaEarthAsia,
	},
];
